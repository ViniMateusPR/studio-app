...
class CriarFichaScreen extends StatefulWidget {
  final Aluno aluno;
  const CriarFichaScreen({super.key, required this.aluno});

  @override
  State<CriarFichaScreen> createState() => _CriarFichaScreenState();
}

class _CriarFichaScreenState extends State<CriarFichaScreen> {
  ...
  Future<void> _salvarFicha() async {
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Erro ao criar ficha: $e')),
      );
    } finally {
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              onPressed: _loading ? null : _salvarFicha,
                            ),
                          ),
                        ],
                      ),
